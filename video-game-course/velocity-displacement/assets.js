...
(function (window, draw, mathDudeGamez) {
  ...
  window.opspark.assets = {
    makeShip(color) {
      ...
      Object.assign(ship, mathDudeGamez.phyz.makeBody("ship"));
...
})(window, window.opspark.draw, window.mathDudeGamez);
