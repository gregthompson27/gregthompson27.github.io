...
(function (window, createjs, opspark, rhaussSausse) {
  ...
  var asdf = rhaussSausse.phyz.calculateDistance();
  console.log(asdf);
  /*
  ...
  function update(event) {
     ...
     */
    const mouseObj = { x: stage.mouseX, y: stage.mouseY };
    const { calculateDistance } = rhaussSausse.phyz;
    const distance = calculateDistance(mouseObj, shapeUp);
    /*
